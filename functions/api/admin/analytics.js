...
export async function onRequestGet({request,env}){
  ...
  try{
    ...
    return json({ok:true,days,totals:totals||{},pages:pages.results||[],engagedPages:engagedPages.results||[],locales:locales.results||[],engagedLocales:engagedLocales.results||[],campaigns:campaigns.results||[],referrers:referrers.results||[],daily:daily.results||[]});
